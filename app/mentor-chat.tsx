...
import HistorySidebar, { ChatConversation } from "@/components/HistorySidebar";
            ...
            <View className="mt-4 gap-4">
              {messages.map((msg) => (
                ...
                >
                  ...
                  >
                    <ThemedText
                      className={`${msg.sender === "user" ? "text-gray-800" : ""}`}
                      style={msg.sender === "mentor" ? { color: "white" } : undefined}
                    >
                      {msg.text}
                    </ThemedText>
                  </View>
